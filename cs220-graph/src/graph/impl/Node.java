...
public class Node implements INode
{
	...
	private Map<String, Map<INode, Integer>> mainMap= new HashMap<>();
    ...
    public void addUndirectedEdgeToNode(INode n, int weight) {
       this.addDirectedEdgeToNode(n, weight); // this is name and it creates a direct link from name to n
       n.addDirectedEdgeToNode(this, weight); // this creats a direct link from n to name therefore making it undirected edge
    }
